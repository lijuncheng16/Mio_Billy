      ...
      int nrhs, const mxArray *prhs[])
{
	...
	if (q==OPEN)
        ...
        //my_bool *my_bool_test = "something";
        //if (!mysql_options(conn, MYSQL_SECURE_AUTH, true))
            //mexErrMsgTxt("Diable Secure_auth error");
        conn->options.secure_auth = false; //diable secure auth
