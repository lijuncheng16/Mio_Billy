...
#import "DeviceGatewayScan.h"
#import "AppDelegate.h"

@interface DeviceGatewayScan ()

@end

@implementation DeviceGatewayScan
...
- (void)scanningComplete:(NSTimer*)timer
{
    ...
    _StatusLabel.text = @"Please select a gateway to associate the device to:";
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    //[appDelegate sendMessage:@"Sending encrypted JID and password to gateway \"DemoGateway\""];
    [self performSegueWithIdentifier:@"DeviceQRSegue" sender:self];
}
